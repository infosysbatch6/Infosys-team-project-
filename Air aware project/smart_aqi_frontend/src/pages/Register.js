...
//       <form onSubmit={handleRegister} className="bg-white dark:bg-gray-800 p-10 rounded-lg shadow-lg w-96 flex flex-col gap-6 transition-colors duration-300">
...
//         <input type="password" placeholder="Confirm Password" value={confirm} onChange={e=>setConfirm(e.target.value)} required className="p-3 rounded border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-orange-500"/>
//         <button type="submit" className="bg-green-500 text-white px-4 py-3 rounded hover:bg-green-600 transition">Register</button>
//         <p className="text-sm text-center">Already have an account? <Link to="/login" className="text-blue-500">Login</Link></p>
//       </form>
//     </div>
//   );
// };
